...
def main():
    ...
    parser.add_argument('--env_name',  default='OnlyLong-v0',
                        choices=('OnlyLong-v0')
                        )
    ...
    parser.add_argument('--data_path', '-data', type=str, default='')
    ...
    params['df'] = pd.read_csv(params['data_path']).sort_values('Date')
